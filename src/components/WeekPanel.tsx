...
import { Box, HStack, Typo, VStack } from "@/kumi-ui/index.ts";
...
export const WeekPanel = () => {
	...
	return (
		<HStack w="100%" justify={"center"} gap={"4px"}>
			{days.map((day) => {
				...
				return (
					...
					>
						<Typo
							// fontSize={"14px"}
							color={isSelected ? "Typo" : "subTypo"}
							// fontWeight={isSelected ? "bold" : "regular"}
						>
							{day.dayName}
						</Typo>
						{/* <Typo fontWeight={isSelected ? "bold" : "regular"}>{day.day}</Typo> */}
						<HStack gap={"1.5px"} justify={"center"}>
							<Box
								w={"8px"}
								h={"8px"}
								// borderWidth={"2px"}
